...
const _extractmodulesfromturbopackmessage = require("./extract-modules-from-turbopack-message");
...
async function startWatcher(opts) {
    ...
    async function createHotReloaderTurbopack() {
        ...
        const sendHmrDebounce = (0, _utils2.debounce)(()=>{
            ...
            hotReloader.send({
                ...
                warnings: [],
                updatedModules: [
                    ...(0, _extractmodulesfromturbopackmessage.extractModulesFromTurbopackMessage)(turbopackUpdates)
                ]
            });
            hmrBuilding = false;
            if (errors.size === 0) {
    ...
    const hotReloader = opts.turbo ? await createHotReloaderTurbopack() : new _hotreloaderwebpack.default(opts.dir, {
        appDir,
        pagesDir,
        distDir: distDir,
