                ...
                await Promise.all(Object.keys(entries).map(async (entryKey)=>{
                    ...
                    (0, _entries.runDependingOnPageType)({
                        ...
                        onServer: ()=>{
                            ...
                            } else if (!(0, _utils.isMiddlewareFile)(page) && !(0, _isinternalcomponent.isInternalComponent)(relativeRequest) && !(0, _isinternalcomponent.isNonRoutePagesPage)(page) && !((0, _utils.isInstrumentationHookFile)(page) && pageType === "root")) {
                                value = (0, _nextrouteloader.getRouteLoaderEntry)({
