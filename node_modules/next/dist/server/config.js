...
function assignDefaults(dir, userConfig, silent) {
    var _defaultConfig_experimental, _result_experimental, _result_experimental1, _result_experimental2, _result_experimental_serverActions, _result_experimental3, _result_experimental4, _result_experimental5, _result_experimental6, _result_experimental7, _result_devIndicators, _result_experimental8;
    ...
    if (((_result_experimental = result.experimental) == null ? void 0 : _result_experimental.ppr) && !"14.0.5-canary.51".includes("canary") && !process.env.__NEXT_TEST_MODE) {
