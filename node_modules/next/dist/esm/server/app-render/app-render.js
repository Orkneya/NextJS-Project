   ...
   */ const params = renderOpts.params ?? {};
    ...
    const renderToStream = getTracer().wrap(AppRenderSpan.getBodyResult, {
        ...
        try {
            ...
            /** True if this error was a bailout to client side rendering error. */ const shouldBailoutToCSR = isBailoutToCSRError(err);
            if (shouldBailoutToCSR) {
                console.log();
                if (renderOpts.experimental.missingSuspenseWithCSRBailout) {
                    error(`${err.message} should be wrapped in a suspense boundary at page "${pagePath}". https://nextjs.org/docs/messages/missing-suspense-with-csr-bailout`);
                    throw err;
                }
                warn(`Entire page "${pagePath}" deopted into client-side rendering. https://nextjs.org/docs/messages/deopted-into-client-rendering`);
            }
