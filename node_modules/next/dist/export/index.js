  ...
  Read more: https://nextjs.org/docs/messages/export-image-api`);
    ...
    const renderOpts = {
        ...
        experimental: {
            ...
            missingSuspenseWithCSRBailout: nextConfig.experimental.missingSuspenseWithCSRBailout
        }
    };
    ...
    const filteredPaths = exportPaths.filter((route)=>// Remove default routes -- they don't need to be exported
        // and are only used for parallel route normalization
        !(0, _isdefaultroute.isDefaultRoute)(exportPathMap[route].page) && (exportPathMap[route]._isAppDir || // Remove API routes
